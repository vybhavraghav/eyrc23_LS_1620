...
def sysCall_actuation():
    ...
    #################################
    global e1, e2, Vyaw, Ki1, Ki2, I1, I2

    U = kp1*e1 +kp2*e2  + kd2*Vyaw+ I1+I2
    print(U)
...
def sysCall_sensing():
    ...
    #################################
        #################################
    global bike, motor, e1, e2 , I1,I2,Ki1, Ki2, dt, last_yaw, Vyaw
    yawpoint = 0.4
    dt=sim.getSimulationTime()
    # t = sim.getJointPosition(elbow)
    # a = sim.getJointPosition(pivot)
    _,a,t = sim.getObjectOrientation(bike, base)
